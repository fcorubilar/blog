...
subtitle: "Cuatro décadas de línea de costa medidas desde satélite"
description: |
  El frente costero de Puerto Saavedra retrocede 4,36 metros al año. No se
  había medido antes. Así se hizo, y esto es lo que significa.
date: 2026-08-18
author: "Francisco Rubilar Rocha"
categories: [teledetección, borde costero, Saavedra, gestión del riesgo]
image: img/nubes-lineas-costa.png
image-alt: "Nubes de puntos de la línea de costa de Playa Maule en tres períodos"
lang: es
toc: true
...
|  |  |
|:--:|:--:|
| ![](playamauleponiente.JPG){width="332"} | ![](playamauleponiente2.jpeg) |
...
En el propio Plan de Acción Comunal de Cambio Climático reconocemos la
erosión del borde costero como riesgo comunal, pero en su diseño no se
pudo cuantificar las cadenas de impacto por falta de información local
de base. Este levantamiento es precisamente esa base.

## Cómo se mide una playa desde el espacio

La idea de fondo es simple. El agua y la arena reflejan la luz de forma
muy distinta en el infrarrojo de onda corta: el agua absorbe casi toda
esa energía y aparece oscura, mientras la arena seca la refleja.
Combinando esa banda con la del verde se obtiene un índice que separa
ambas superficies con nitidez, y el límite entre las dos es la línea de
costa.
...
satelitales**, de las que se obtuvieron **1.457 posiciones válidas de la
línea de costa**. Cada posición se mide con precisión subpíxel, es decir
mejor que el tamaño nominal de la celda de 30 metros, mediante
interpolación del índice espectral.
